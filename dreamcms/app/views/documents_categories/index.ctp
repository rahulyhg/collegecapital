<div class="documentsCategories index">
	...
	?>
        <div id="record_wrap" <?php echo $class;?>>
            <div style="width:20px" id="record_row">
                <div id="record_detail"><?php echo $documentsCategory['DocumentsCategory']['id']; ?>&nbsp;</div>
            </div>
            <div style="width:80%" id="record_row">
                <div id="record_detail"><?php echo $documentsCategory['DocumentsCategory']['category']; ?>&nbsp;</div>
            </div>
            <div style="width:50px" id="record_row">
                <div id="record_option" class="imgEdit"><?php echo $this->Html->link($html->image("edit.gif",array('id'=>'edit','alt'=>'edit')), array('action' => 'edit', $documentsCategory['DocumentsCategory']['id']), array('escape' => false,'id'=>'record','title'=>'edit')); ?></div>
            </div>
            <div style="width:50px" id="record_row">
			 <?php 	
					foreach ($hasNoDocumentItems as $hasNoDocuments){
						if($hasNoDocuments['DocumentsCategory']['id'] === $documentsCategory['DocumentsCategory']['id']){
			?>
                <div id="record_option" class="imgDelete"><?php echo $this->Html->link($html->image("delete.gif",array('id'=>'delete','alt'=>'delete')), array('action' => 'delete', $documentsCategory['DocumentsCategory']['id']), array('escape' => false,'id'=>'record','title'=>'delete'), sprintf(__('Are you sure you want to delete # %s?', true), $documentsCategory['DocumentsCategory']['id'])); ?></div>
            <?php		}
					}
			?>
            </div>

...
<div class="claimsIndustryprofile form">
<div id="record">
        <div id="record_header_wrap">
        	<div id="record_header">
        		<div id="record_detail">Edit Item: <?php echo $this->data['ClaimsIndustryprofile']['id']; ?></div>
        	</div>
    	</div>
		<?php 
		echo $this->Form->create('ClaimsIndustryprofile', array('class'=>'editForm'));
		echo $this->Form->input('id');
		echo $this->Form->input('industryProfile');
		?>
    	<div id="record_wrap">

...
<div class="claimsProducttypes form">
<div id="record">
        <div id="record_header_wrap">
        	<div id="record_header">
        		<div id="record_detail">Edit Item: <?php echo $this->data['ClaimsProducttype']['id']; ?></div>
        	</div>
    	</div>
		<?php 
		echo $this->Form->create('ClaimsProducttype', array('class'=>'editForm'));

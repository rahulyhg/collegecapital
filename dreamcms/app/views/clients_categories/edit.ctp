...
<div class="clientsCategories form">
<div id="record">
        <div id="record_header_wrap">
        	<div id="record_header">
        		<div id="record_detail">Edit Item: <?php echo $this->data['ClientsCategory']['id']; ?></div>
        	</div>
    	</div>
		<?php 
		echo $this->Form->create('ClientsCategory', array('class'=>'editForm'));

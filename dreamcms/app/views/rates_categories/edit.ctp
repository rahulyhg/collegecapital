...
$(function(){
	$('#RatesCategoryCategory').friendurl({id : 'RatesCategorySeoCatName', transliterate: true});
});
</script>
<div class="ratesCategories form">
<div id="record">
        <div id="record_header_wrap">
        	<div id="record_header">
        		<div id="record_detail">Edit Item: <?php echo $this->data['RatesCategory']['id']; ?></div>
        	</div>
    	</div>
		<?php 
		echo $this->Form->create('RatesCategory', array('class'=>'editForm'));
		...
		?>
		<script type="text/javascript">
			var ck_ratesCategoryDescription = CKEDITOR.replace( 'RatesCategoryDescription', { 
															toolbar: 'Basic',
			...
			CKFinder.setupCKEditor( ck_ratesCategoryDescription, '<?php echo $ckfinderPath ?>') ;
        </script>
 		<div id="record_wrap">

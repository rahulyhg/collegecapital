<?php $this->set('page','vbisSetting');?>
<div class="settings form">
<div id="record">
        <div id="record_header_wrap">
        	<div id="record_header">
        		<div id="record_detail">Edit Item: <?php echo $this->data['VbisSetting']['id']; ?></div>
        	</div>
    	</div>
		<?php 
			echo $this->Form->create('VbisSetting', array('class'=>'editForm'));
			echo $this->Form->input('id');
			echo $this->Form->input('key', array('readonly'=>'readonly'));

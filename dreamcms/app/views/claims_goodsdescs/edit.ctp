...
<div class="claimGoodsdescs form">
<div id="record">
        <div id="record_header_wrap">
        	<div id="record_header">
        		<div id="record_detail">Edit Item: <?php echo $this->data['ClaimsGoodsdesc']['id']; ?></div>
        	</div>
    	</div>
		<?php 
		echo $this->Form->create('ClaimsGoodsdesc', array('class'=>'editForm'));
		echo $this->Form->input('id');
		echo $this->Form->input('goodsDescription');
		?>
    	<div id="record_wrap">
